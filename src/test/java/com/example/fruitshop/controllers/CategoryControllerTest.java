...
import com.example.fruitshop.controller.CategoryController;
...
public class CategoryControllerTest {
    ...
    public void testListCategories() throws Exception {
        ...
        category1.setId(1L);
        category1.setName(IDAN_NAME);

        CategoryDTO category2 = new CategoryDTO();
        category2.setId(2L);
        category2.setName(ROIE_NAME);
    ...
    public void testGetByNameCategories() throws Exception {
        ...
        mockMvc.perform(get("/api/v1/categories/Idan")
                .contentType(MediaType.APPLICATION_JSON))
                .andExpect(status().isOk())
                .andExpect(jsonPath("$.name", equalTo(IDAN_NAME)));
    }
